...
var webSocket_config_1 = require("./src/library/webSocket.config");
var Wsend = /** @class */ (function () {
    ...
    Wsend.prototype.send = function (content) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                axios_1.default.post(_this.URl, PostData, (0, webSocket_config_1.WebhookConfig)(_this.WebhookOptions));
                resolve();
            }
            catch (error) {
                reject(error);
